...
const { purposalCreate, editPurposal, listAgencyPurposal, purposalDelete, getPurposal, listPromoterPurposal,getPurposalsByArtist } = require("../controllers/purposal.controller");
